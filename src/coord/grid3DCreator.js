...
function updateCartesian3D(ecModel, api) {
    ...
    ecModel.eachSeries(function (seriesModel) {
        ...
        ['x', 'y', 'z'].forEach(function (coordDim) {
            data.mapDimensionsAll(coordDim).forEach(function (dataDim) {
                unionDataExtents(
    ...
    ['xAxis3D', 'yAxis3D', 'zAxis3D'].forEach(function (axisType) {
        ecModel.eachComponent(axisType, function (axisModel) {
            ...
            var grid3DModel = axisModel.getReferringComponents('grid3D', { useDefault: true, enableAll: false, enableNone: false }).models[0];
    ...
    create: function (ecModel, api) {
        ...
        function findAxesModels(seriesModel, ecModel) {
            return axesTypes.map(function (axisType) {
                var axisModel = seriesModel.getReferringComponents(axisType, { useDefault: true, enableAll: false, enableNone: false }).models[0];
                if (axisModel == null) {
        ...
        ecModel.eachSeries(function (seriesModel) {
            ...
            var firstGridModel = seriesModel.getReferringComponents('grid3D', { useDefault: true, enableAll: false, enableNone: false }).models[0];
